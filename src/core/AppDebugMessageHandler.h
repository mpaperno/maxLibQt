...
/**
	...
	or install a QIODevice to recieve the output).

	Include this header to use qInfo() safely with Qt < v5.5 (qInfo becomes alias for qDebug).

	Note that the default message format can still be overriden by setting \e QT_MESSAGE_PATTERN environment variable at _runtime_.
